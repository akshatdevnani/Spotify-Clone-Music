...
const music = new Audio('./aud/18.mp3');

function defaultplay(){
     music.src='./aud/18.mp3';
...
const songs = [
    ...
    {
        id:'2',
        songName:` There's Nothing Holdin me Back <br>
    ...
    {
        id:"12",
        songName: `Uff Teri Ada<br><div class="subtitle">Kartik Calling Kartik</div>`,
    ...
    {
        id:"14",
        songName: `Tujhe Kitna Chahne Lage Ham <br><div class="subtitle">Kabir Singh</div>`,
    ...
    {
        id:"17",
        songName: `Gangsta's Paradise<br><div class="subtitle">Coolio</div>`,
